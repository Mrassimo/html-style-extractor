    ...
    <div className="bg-md-white rounded-lg shadow-md-md-soft border border-md-border overflow-hidden">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-6 bg-md-white border-b border-md-border gap-4">
        <div>
          ...
          <p className="text-sm text-md-muted">Design analysis with screenshots • Download complete package below</p>
        </div>
      </div>
              ...
              <div className="mb-10">
                  ...
                  <div className="mt-4 p-3 bg-md-yellow border border-md-orange rounded-lg text-center">
                      <p className="text-sm text-md-body">
                          💡 <strong>Tip:</strong> Click on any screenshot to expand it, or right-click to copy the image URL
                      </p>
                  </div>
              </div>
          )}
            ...
            <div className="bg-md-white rounded-lg border border-md-border p-6">
              ...
              <div className="mt-4 text-center">
                <p className="text-xs text-md-muted">
                  💾 Download complete ZIP with all assets • 📋 Copy analysis for AI workflows
                </p>
              </div>
            </div>
          </div>
